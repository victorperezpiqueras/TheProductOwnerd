...
router.get('/usuarios/:id/proyectos', function (req, res, next) {
    ...
    controllerUsuarios.getUsuariosProyectos(req.params.id)
...
router.get('/usuarios/:id/proyectos/:idp/permisos', function (req, res, next) {
    ...
    controllerUsuarios.getUsuariosProyectosPermisos(req.params.id, req.params.idp)
...
router.get('/proyectos', function (req, res, next) {
    ...
    controllerProyectos.getProyectos()
        .then(function (proyectos) {
            res.json(proyectos);
        })
        .catch(function (err) {
